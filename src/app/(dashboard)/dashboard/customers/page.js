...
function CustomerRow({ customer, onView }) {
  const successRate = getSuccessRate(customer.courierHistory);

  return (
    <div
      className={`grid grid-cols-1 gap-3 border-b border-white/5 px-4 py-4 hover:bg-white/3 md:items-center md:gap-4 md:py-3 ${gridCols}`}
    >
      {/* Customer ID */}
      <div className="flex items-center justify-between md:block">
        ...
        <span className="font-medium text-[#F5F5F5]">{customer.id}</span>
      </div>
      ...
      <div className="flex items-center justify-between md:block">
        ...
        <span className="text-[#F5F5F5]/80">{customer.name}</span>
      </div>
      ...
      <div className="flex items-center justify-between md:block">
        ...
        <span className="text-[#F5F5F5]/40">{customer.phone}</span>
      </div>
      ...
      <div className="flex items-center justify-between md:block">
        ...
        <span className={`font-medium ${successRateColor(successRate)}`}>
      ...
      <div className="flex items-center justify-between md:block">
        ...
        <span className="text-[#F5F5F5]/80">{customer.totalOrders}</span>
      </div>
